...
namespace Server.MirEnvir
    ...
    public class Envir
        ...
        static Envir()
            {
            AccountIDReg =
                new Regex(@"^[A-Za-z0-9_\-\u4e00-\u9fa5]{" + Globals.MinAccountIDLength + "," + Globals.MaxAccountIDLength + "}$");
            PasswordReg =
                new Regex(@"^[A-Za-z0-9]{" + Globals.MinPasswordLength + "," + Globals.MaxPasswordLength + "}$");
            EMailReg = new Regex(@"\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*");
            CharacterReg =
                new Regex(@"^[A-Za-z0-9_\-\u4e00-\u9fa5]{" + Globals.MinCharacterNameLength + "," + Globals.MaxCharacterNameLength +
                          "}$");
   ...
   */
        ...
        public void SaveDB()
            ...
            try
                ...
                connection.ConnectionString = connectionString;
                connection.Open();
                string create = "CREATE DATABASE IF NOT EXISTS `" + Settings.DBServer + "` DEFAULT CHARSET utf8 COLLATE utf8_general_ci; USE `" + Settings.DBServer + "`;CREATE TABLE IF NOT EXISTS `conquestarcherinfo` (  `IndexID` int(20) DEFAULT NULL,  `Location_X` varchar(50) NOT NULL DEFAULT '0',  `Location_Y` varchar(50) NOT NULL DEFAULT '0',  `MobIndex` int(20) DEFAULT NULL,  `Name` varchar(50) NOT NULL DEFAULT '0',  `RepairCost` int(20) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `conquestextramaps` (  `IndexID` int(20) DEFAULT NULL,  `ExtraMaps` int(20) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `conquestflag` (  `IndexID` int(20) DEFAULT NULL,  `Location_X` varchar(50) NOT NULL DEFAULT '0',  `Location_Y` varchar(50) NOT NULL DEFAULT '0',  `Name` varchar(50) NOT NULL DEFAULT '0',  `FileName` varchar(50) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `conquestgateinfo` (  `IndexID` int(20) DEFAULT NULL,  `Location_X` varchar(50) NOT NULL DEFAULT '0',  `Location_Y` varchar(50) NOT NULL DEFAULT '0',  `MobIndex` int(20) DEFAULT NULL,  `Name` varchar(50) NOT NULL DEFAULT '0',  `RepairCost` int(20) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `conquestinfo` (  `IndexID` int(11) NOT NULL,  `Location_X` varchar(50) NOT NULL DEFAULT '0',  `Location_Y` varchar(50) NOT NULL DEFAULT '0',  `Size` smallint(11) DEFAULT NULL,  `Name` varchar(50) NOT NULL DEFAULT '0',  `MapIndex` int(11) NOT NULL DEFAULT '0',  `PalaceIndex` int(11) NOT NULL DEFAULT '0',  `GuardIndex` int(11) NOT NULL DEFAULT '0',  `GateIndex` int(11) NOT NULL DEFAULT '0',  `WallIndex` int(11) NOT NULL DEFAULT '0',  `SiegeIndex` int(11) NOT NULL DEFAULT '0',  `WarLength` int(11) NOT NULL DEFAULT '0',  `StartHour` int(3) NOT NULL DEFAULT '0',  `Type` int(11) NOT NULL DEFAULT '0',  `Game` int(11) NOT NULL DEFAULT '0',  `Monday` bit(1) NOT NULL DEFAULT b'0',  `Tuesday` bit(1) NOT NULL DEFAULT b'0',  `Wednesday` bit(1) NOT NULL DEFAULT b'0',  `Thursday` bit(1) NOT NULL DEFAULT b'0',  `Friday` bit(1) NOT NULL DEFAULT b'0',  `Saturday` bit(1) NOT NULL DEFAULT b'0',  `Sunday` bit(1) NOT NULL DEFAULT b'0',  `KingLocation_X` varchar(50) NOT NULL DEFAULT '0',  `KingLocation_Y` varchar(50) NOT NULL DEFAULT '0',  `KingSize` bigint(20) DEFAULT '0',  `FullMap` int(1) DEFAULT '0',  `FlagIndex` int(3) DEFAULT '0',  `ControlPointIndex` int(3) DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `conquestsiegeinfo` (  `IndexID` int(20) DEFAULT NULL,  `Location_X` varchar(50) NOT NULL DEFAULT '0',  `Location_Y` varchar(50) NOT NULL DEFAULT '0',  `MobIndex` int(20) DEFAULT NULL,  `Name` varchar(50) NOT NULL DEFAULT '0',  `RepairCost` int(20) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `conquestwallinfo` (  `IndexID` int(20) DEFAULT NULL,  `Location_X` varchar(50) NOT NULL DEFAULT '0',  `Location_Y` varchar(50) NOT NULL DEFAULT '0',  `MobIndex` int(20) DEFAULT NULL,  `Name` varchar(50) NOT NULL DEFAULT '0',  `RepairCost` int(20) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `dragoninfo` (  `IndexID` int(11) NOT NULL AUTO_INCREMENT,  `Enabled` tinyint(1) NOT NULL,  `MapFileName` varchar(200) DEFAULT NULL,  `MonsterName` varchar(200) DEFAULT NULL,  `BodyName` varchar(200) DEFAULT NULL,  `Location_X` varchar(200) DEFAULT NULL,  `Location_Y` varchar(200) DEFAULT NULL,  `DropAreaTop_X` varchar(200) DEFAULT NULL,  `DropAreaTop_Y` varchar(200) DEFAULT NULL,  `DropAreaBottom_X` varchar(200) DEFAULT NULL,  `DropAreaBottom_Y` varchar(200) DEFAULT NULL,  `Exps_0` bigint(20) DEFAULT NULL,  `Exps_1` bigint(20) DEFAULT NULL,  `Exps_2` bigint(20) DEFAULT NULL,  `Exps_3` bigint(20) DEFAULT NULL,  `Exps_4` bigint(20) DEFAULT NULL,  `Exps_5` bigint(20) DEFAULT NULL,  `Exps_6` bigint(20) DEFAULT NULL,  `Exps_7` bigint(20) DEFAULT NULL,  `Exps_8` bigint(20) DEFAULT NULL,  `Exps_9` bigint(20) DEFAULT NULL,  `Exps_10` bigint(20) DEFAULT NULL,  `Exps_11` bigint(20) DEFAULT NULL,  PRIMARY KEY (`IndexID`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `gameshopitem` (  `ItemIndex` int(11) NOT NULL DEFAULT '0',  `GIndex` int(11) DEFAULT NULL,  `GoldPrice` int(11) DEFAULT NULL,  `CreditPrice` int(11) DEFAULT NULL,  `Count` int(11) DEFAULT NULL,  `Stock` int(11) DEFAULT NULL,  `Class` varchar(200) DEFAULT NULL,  `Category` varchar(200) DEFAULT NULL,  `iStock` tinyint(1) DEFAULT NULL,  `Deal` tinyint(1) DEFAULT NULL,  `TopItem` tinyint(1) DEFAULT NULL,  `Date` datetime DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `iteminfo` (  `IndexID` int(11) NOT NULL DEFAULT '0',  `Name` varchar(1000) DEFAULT '',  `Accuracy` tinyint(4) DEFAULT '0',  `Agility` int(3) DEFAULT '0',  `AttackSpeed` int(3) DEFAULT '0',  `Durability` int(11) DEFAULT '0',  `BagWeight` int(3) DEFAULT '0',  `CanAwakening` int(1) DEFAULT '0',  `CanFastRun` int(1) DEFAULT '0',  `CanMine` int(1) DEFAULT '0',  `ClassBased` int(1) DEFAULT '0',  `ShowGroupPickup` int(1) DEFAULT '0',  `CriticalDamage` int(3) DEFAULT '0',  `CriticalRate` int(3) DEFAULT '0',  `Effect` int(3) DEFAULT '0',  `Freezing` int(3) DEFAULT '0',  `SpellRecovery` int(3) DEFAULT '0',  `HandWeight` int(3) DEFAULT '0',  `HealthRecovery` int(3) DEFAULT '0',  `Holy` int(3) DEFAULT '0',  `HpDrainRate` int(3) DEFAULT '0',  `HPrate` int(3) DEFAULT '0',  `Light` int(3) DEFAULT '0',  `Luck` int(3) DEFAULT '0',  `LevelBased` int(1) DEFAULT '0',  `NeedIdentify` int(1) DEFAULT '0',  `StartItem` int(1) DEFAULT '0',  `MagicResist` int(3) DEFAULT '0',  `MaxAC` int(3) DEFAULT '0',  `MaxAcRate` int(3) DEFAULT '0',  `MaxDC` int(3) DEFAULT '0',  `MaxMAC` int(3) DEFAULT '0',  `MaxMacRate` int(3) DEFAULT '0',  `MaxMC` int(3) DEFAULT '0',  `MaxSC` int(3) DEFAULT '0',  `MinAC` int(3) DEFAULT '0',  `MinDC` int(3) DEFAULT '0',  `MinMAC` int(3) DEFAULT '0',  `MinMC` int(3) DEFAULT '0',  `MinSC` int(3) DEFAULT '0',  `MPrate` int(3) DEFAULT '0',  `PoisonAttack` int(3) DEFAULT '0',  `PoisonRecovery` int(3) DEFAULT '0',  `PoisonResist` int(3) DEFAULT '0',  `Reflect` int(3) DEFAULT '0',  `Strong` int(3) DEFAULT '0',  `RandomStatsId` int(3) DEFAULT '0',  `RequiredAmount` int(3) DEFAULT '0',  `WearWeight` int(3) DEFAULT '0',  `Weight` int(3) DEFAULT '0',  `Price` int(10) DEFAULT '0',  `StackSize` int(10) DEFAULT '0',  `Grade` smallint(10) DEFAULT '0',  `Bind` smallint(10) DEFAULT '0',  `RequiredClass` int(10) DEFAULT '0',  `Type` int(10) DEFAULT '0',  `Unique_` int(10) DEFAULT '0',  `ToolTip` varchar(1000) DEFAULT '',  `RequiredGender` int(10) DEFAULT '0',  `RequiredType` int(10) DEFAULT '0',  `Set_` int(10) DEFAULT '0',  `HP` smallint(11) DEFAULT '0',  `MP` smallint(11) DEFAULT '0',  `Image` smallint(11) DEFAULT '0',  `Shape` smallint(11) DEFAULT '0',  `InGame` int(11) DEFAULT '0',  PRIMARY KEY (`IndexID`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `magicinfo` (  `Name` varchar(50) DEFAULT NULL,  `Spell` smallint(6) DEFAULT NULL,  `BaseCost` int(3) DEFAULT NULL,  `LevelCost` int(3) DEFAULT NULL,  `Icon` int(3) DEFAULT NULL,  `Level1` int(3) DEFAULT NULL,  `Level2` int(3) DEFAULT NULL,  `Level3` int(3) DEFAULT NULL,  `Range_` int(3) DEFAULT NULL,  `Need1` smallint(6) DEFAULT NULL,  `Need2` smallint(6) DEFAULT NULL,  `Need3` smallint(6) DEFAULT NULL,  `PowerBase` smallint(6) DEFAULT NULL,  `PowerBonus` smallint(6) DEFAULT NULL,  `MPowerBase` smallint(6) DEFAULT NULL,  `MPowerBonus` smallint(6) DEFAULT NULL,  `DelayBase` int(11) DEFAULT NULL,  `DelayReduction` int(11) DEFAULT NULL,  `MultiplierBase` float DEFAULT NULL,  `MultiplierBonus` float DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `mapinfo` (  `IndexID` int(11) NOT NULL DEFAULT '0',  `FileName` varchar(50) NOT NULL DEFAULT '0',  `Title` varchar(50) NOT NULL DEFAULT '0',  `NoReconnectMap` varchar(50) NOT NULL DEFAULT '0',  `MiniMap` smallint(6) NOT NULL DEFAULT '0',  `BigMap` smallint(6) NOT NULL DEFAULT '0',  `Music` smallint(6) NOT NULL DEFAULT '0',  `Light` int(3) NOT NULL DEFAULT '0',  `MapDarkLight` int(3) NOT NULL DEFAULT '0',  `FireDamage` int(3) NOT NULL DEFAULT '0',  `LightningDamage` int(3) NOT NULL DEFAULT '0',  `MineIndex` int(3) NOT NULL DEFAULT '0',  `NoTeleport` bit(1) NOT NULL DEFAULT b'0',  `NoReconnect` bit(1) NOT NULL DEFAULT b'0',  `NoRandom` bit(1) NOT NULL DEFAULT b'0',  `NoEscape` bit(1) NOT NULL DEFAULT b'0',  `NoRecall` bit(1) NOT NULL DEFAULT b'0',  `NoDrug` bit(1) NOT NULL DEFAULT b'0',  `NoPosition` bit(1) NOT NULL DEFAULT b'0',  `NoFight` bit(1) NOT NULL DEFAULT b'0',  `NoThrowItem` bit(1) NOT NULL DEFAULT b'0',  `NoDropPlayer` bit(1) NOT NULL DEFAULT b'0',  `NoDropMonster` bit(1) NOT NULL DEFAULT b'0',  `NoNames` bit(1) NOT NULL DEFAULT b'0',  `NoMount` bit(1) NOT NULL DEFAULT b'0',  `NeedBridle` bit(1) NOT NULL DEFAULT b'0',  `Fight` bit(1) NOT NULL DEFAULT b'0',  `NeedHole` bit(1) NOT NULL DEFAULT b'0',  `Fire` bit(1) NOT NULL DEFAULT b'0',  `Lightning` bit(1) NOT NULL DEFAULT b'0') ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `minezone` (  `MapMineIndex` int(11) NOT NULL DEFAULT '0',  `Mine` int(3) NOT NULL DEFAULT '0',  `Location_X` varchar(50) NOT NULL DEFAULT '0',  `Location_Y` varchar(50) NOT NULL DEFAULT '0',  `Size` smallint(11) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `monsterinfo` (  `IndexID` int(11) NOT NULL DEFAULT '0',  `Name` varchar(200) DEFAULT NULL,  `AI` int(4) DEFAULT NULL,  `AttackSpeed` smallint(6) DEFAULT NULL,  `Accuracy` tinyint(4) DEFAULT NULL,  `AutoRev_` tinyint(1) DEFAULT NULL,  `CanPush` tinyint(1) DEFAULT NULL,  `CanTame` tinyint(1) DEFAULT NULL,  `CoolEye_` tinyint(4) DEFAULT NULL,  `Effect` tinyint(4) DEFAULT NULL,  `Experience` int(11) DEFAULT NULL,  `HP` int(11) DEFAULT NULL,  `Image` smallint(6) DEFAULT NULL,  `Level` smallint(6) DEFAULT NULL,  `Light` tinyint(4) DEFAULT NULL,  `MaxAC` smallint(6) DEFAULT NULL,  `MaxDC` smallint(6) DEFAULT NULL,  `MaxMAC` smallint(6) DEFAULT NULL,  `MaxMC` smallint(6) DEFAULT NULL,  `MaxSC` smallint(6) DEFAULT NULL,  `MinAC` smallint(6) DEFAULT NULL,  `MinDC` smallint(6) DEFAULT NULL,  `MinMAC` smallint(6) DEFAULT NULL,  `MinMC` smallint(6) DEFAULT NULL,  `MinSC` smallint(6) DEFAULT NULL,  `MoveSpeed` smallint(6) DEFAULT NULL,  `Undead_` tinyint(1) DEFAULT NULL,  `ViewRange` tinyint(4) DEFAULT NULL,  `Agility` tinyint(4) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `movements` (  `IndexIDTied` int(11) NOT NULL DEFAULT '0',  `MapIndex` int(11) NOT NULL DEFAULT '0',  `Source_X` varchar(50) NOT NULL DEFAULT '0',  `Source_Y` varchar(50) NOT NULL DEFAULT '0',  `Destination_X` varchar(50) NOT NULL DEFAULT '0',  `Destination_Y` varchar(50) NOT NULL DEFAULT '0',  `ConquestIndex` varchar(50) NOT NULL DEFAULT '0',  `NeedHole` bit(1) NOT NULL DEFAULT b'0',  `NeedMove` bit(1) NOT NULL DEFAULT b'0') ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `npcinfo` (  `IndexID` int(11) DEFAULT NULL,  `MapIndex` int(11) DEFAULT NULL,  `Name` varchar(200) DEFAULT NULL,  `FileName` varchar(200) DEFAULT NULL,  `Location_X` varchar(50) NOT NULL DEFAULT '0',  `Location_Y` varchar(50) NOT NULL DEFAULT '0',  `Rate` smallint(6) DEFAULT '0',  `Image` tinyint(4) DEFAULT '0',  `HourStart` tinyint(4) DEFAULT '0',  `MinuteStart` tinyint(4) DEFAULT '0',  `HourEnd` tinyint(4) DEFAULT '0',  `MinuteEnd` tinyint(4) DEFAULT '0',  `TimeVisible` int(1) DEFAULT '0',  `IsDefault` int(1) DEFAULT '0',  `MinLev` smallint(6) DEFAULT '0',  `MaxLev` smallint(6) DEFAULT '0',  `DayofWeek` varchar(200) DEFAULT NULL,  `ClassRequired` varchar(200) DEFAULT NULL,  `Conquest` int(11) DEFAULT NULL, `FlagNeeded` int(11) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `questinfo` (  `IndexID` int(11) NOT NULL DEFAULT '0',  `Name` varchar(1000) NOT NULL DEFAULT '0',  `Group_` varchar(1000) NOT NULL DEFAULT '0',  `FileName` varchar(1000) NOT NULL DEFAULT '0',  `GotoMessage` varchar(1000) NOT NULL DEFAULT '0',  `KillMessage` varchar(1000) NOT NULL DEFAULT '0',  `ItemMessage` varchar(1000) NOT NULL DEFAULT '0',  `FlagMessage` varchar(1000) NOT NULL DEFAULT '0',  `RequiredMinLevel` int(4) NOT NULL DEFAULT '0',  `RequiredMaxLevel` int(4) NOT NULL DEFAULT '0',  `RequiredQuest` int(4) NOT NULL DEFAULT '0',  `RequiredClass` tinyint(4) DEFAULT NULL,  `Type` tinyint(4) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `respawninfo` (  `MapRespawnIndex` int(11) NOT NULL DEFAULT '0',  `RespawnIndex` int(11) NOT NULL DEFAULT '0',  `MonsterIndex` int(11) NOT NULL DEFAULT '0',  `Location_X` varchar(50) NOT NULL DEFAULT '0',  `Location_Y` varchar(50) NOT NULL DEFAULT '0',  `RoutePath` varchar(50) NOT NULL DEFAULT '0',  `Direction` bit(2) NOT NULL DEFAULT b'0',  `SaveRespawnTime` int(1) NOT NULL DEFAULT '0',  `Count` smallint(11) NOT NULL DEFAULT '0',  `Spread` smallint(11) NOT NULL DEFAULT '0',  `Delay` smallint(11) NOT NULL DEFAULT '0',  `RandomDelay` smallint(11) NOT NULL DEFAULT '0',  `RespawnTicks` smallint(11) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `respawntickoption` (  `UserCount` int(20) DEFAULT NULL,  `DelayLoss` double DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `respawntimer` (  `BaseSpawnRate` int(4) DEFAULT NULL,  `CurrentTickcounter` bigint(20) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `safezoneinfo` (  `SafeMapIndex` int(11) NOT NULL DEFAULT '0',  `Size` smallint(11) NOT NULL DEFAULT '0',  `StartPoint` bit(1) NOT NULL DEFAULT b'0',  `Location_X` varchar(50) NOT NULL DEFAULT '0',  `Location_Y` varchar(50) NOT NULL DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;CREATE TABLE IF NOT EXISTS `servercount` (  `IndexID` int(20) DEFAULT '1',  `Version` int(20) DEFAULT '0',  `CustomVersion` int(20) DEFAULT '0',  `MonsterIndex` int(20) DEFAULT '0',  `NPCIndex` int(20) DEFAULT '0',  `QuestIndex` int(20) DEFAULT '0',  `ItemIndex` int(20) DEFAULT '0',  `MapIndex` int(20) DEFAULT '0',  `ConquestIndex` int(20) DEFAULT '0',  `GameshopIndex` int(20) DEFAULT '0',  `RespawnIndex` int(20) DEFAULT '0') ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci; CREATE TABLE IF NOT EXISTS `conquestpoint` ( `IndexID` int(20) DEFAULT NULL, `Location_X` varchar(50) NOT NULL DEFAULT '0', `Location_Y` varchar(50) NOT NULL DEFAULT '0',`Name` varchar(50) NOT NULL DEFAULT '0', `FileName` varchar(50) NOT NULL DEFAULT '0') ENGINE = InnoDB DEFAULT CHARSET = utf8;";
